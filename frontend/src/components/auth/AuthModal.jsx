              ...
              <div>
                <div className='flex items-center justify-between mb-1.5 sm:mb-2'>
                  ...
                  {mode === "login" && (
                    <a
                      href='#'
                      className='text-xs sm:text-sm text-secondary-500 hover:text-secondary-600 hover:underline font-medium'>
                      Forgot password?
                    </a>
                  )}
                </div>
                ...
                <>
                  <div className='relative my-4'>
                    ...
                    <div className='relative flex justify-center text-xs sm:text-sm'>
                      <span className='px-2 sm:px-3 bg-surface-white text-text-muted'>
                        Or continue with
                      </span>
                    </div>
                  </div>
